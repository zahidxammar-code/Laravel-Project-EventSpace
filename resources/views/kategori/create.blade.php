...
@section('title', 'Tambah Kategori - Sistem Event')
...
@section('content')
    <div class="max-w-xl mx-auto">
        ...
        <div class="pb-6 mb-6 border-b border-slate-800">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight text-white">Tambah Kategori</h1>
            <p class="text-slate-400 text-xs sm:text-sm mt-1">Buat kategori baru untuk mengelompokkan jenis acara.</p>
        </div>
        ...
        <div class="rounded-3xl bg-slate-950/40 border border-slate-800/80 p-6 sm:p-8 backdrop-blur-xl shadow-xl">
            <form method="POST" action="{{ route('kategori.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}" placeholder="Contoh: Teknologi, Olahraga, Seminar"
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="4" placeholder="Tuliskan keterangan singkat mengenai kategori ini..."
